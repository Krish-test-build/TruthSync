  ...
  return (
    ...
    <div className="h-full w-44  flex flex-col items-center z-10">
              ...
              <div className="text-white text-center text-[40px]  flex flex-col items-center font-[monaco] font-bold mt-16 space-y-8">
                <Link to="/home" className="hover:scale-110 transition  cursor-pointer"style={{ textShadow: '3px 3px 2.5px #51E5F8' }}>Home</Link>
                <div className="hover:scale-110 transition leading-8 cursor-pointer "style={{ textShadow: '3px 3px 2.5px #51E5F8' }}>Top  Claims</div>
                ...
                }} className="hover:scale-110 transition cursor-pointer "style={{ textShadow: '3px 3px 2.5px #51E5F8' }}>Categories</button>
